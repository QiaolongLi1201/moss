...
// meant to sit next to the product name the way Claude Code's `✻` sits next to
// "Claude Code". Colors are applied by the caller so each part keeps its hue.
// ────────────────────────────────────────────────────────────────────────────

/** Logo orange (cloud / prompt). Matches theme token `claude`. */

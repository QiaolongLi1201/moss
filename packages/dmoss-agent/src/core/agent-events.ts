...
import type { LlmErrorCategory } from './llm-error-classifier.js';
...
type MiniAgentEventPayload =
  ...
  | { type: 'tool_execution_end'; toolCallId: string; toolName: string; result: string; isError: boolean; content?: string; aborted?: { by: 'user' | 'timeout' } }
